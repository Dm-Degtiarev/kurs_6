"""
Django settings for kurs_6 project.
...
SECRET_KEY = 'django-insecure-xc!)667!3ug3mld7sm@aq5k!=c4z)^5)^r#l(xc_v#g7qqe=rk'
...
WSGI_APPLICATION = 'kurs_6.wsgi.application'
...
CRONJOBS = [
    ('*/10 * * * * *', 'mailing.services.send_message')
]
